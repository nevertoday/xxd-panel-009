...
| 모드 | 화면비 규칙 | 결과물 |
| --- | --- | --- |
| `top-bottom` | 사용자가 확인한 전체 캔버스 | 완성 캔버스를 한 번에 생성: 위에 고충실도 원본, 아래에 009 디자인, 약 50/50 |
| `left-right` | 사용자가 확인한 전체 캔버스 | 완성 캔버스를 한 번에 생성: 왼쪽에 고충실도 원본, 오른쪽에 009 디자인, 약 50/50 |
| `design-only` | 사용자가 확인한 전체 캔버스 | 009 디자인이 전체를 채우며 원본 사진은 보이지 않음 |
