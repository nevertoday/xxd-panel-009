...
| モード | 画角ルール | 成果物 |
| --- | --- | --- |
| `top-bottom` | ユーザー確認済みの完成画角 | 完成キャンバスを一度に生成：上に高忠実度の元画像、下に 009 デザイン、約50/50 |
| `left-right` | ユーザー確認済みの完成画角 | 完成キャンバスを一度に生成：左に高忠実度の元画像、右に 009 デザイン、約50/50 |
| `design-only` | ユーザー確認済みの完成画角 | 009 デザインが全画面を満たし、元画像は表示しない |
