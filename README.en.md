...
That frustration is why I made **Panel 009**. It does not press a template onto your image. It first works out what must not be lost, then translates it into **Compress a photograph into one small anchor, vast paper space, and a dense-to-sparse halftone poem**.
...
<table>
  ...
  <tr>
    <td colspan="2"><img src="./assets/examples/sample-05.png" alt="XXD Panel 009 Sample 5"></td>
  </tr>
  <tr>
    <td width="33%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 009 Sample 6"></td>
    <td width="33%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 009 Sample 7"></td>
    <td width="33%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 009 Sample 8"></td>
  </tr>
</table>
