...
| --- | --- | --- |
| `top-bottom` | user-confirmed whole canvas | one complete generation: high-fidelity source above, 009 design below, approximately 50/50 |
| `left-right` | user-confirmed whole canvas | one complete generation: high-fidelity source left, 009 design right, approximately 50/50 |
| `design-only` | user-confirmed whole canvas | 009 design fills the canvas; source remains invisible |
...
```text
/xxd-panel-009 photo.jpg --mode top-bottom,design-only --size auto,3:4,9:16 --text auto --locale ja-JP
```
