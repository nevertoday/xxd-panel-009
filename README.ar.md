...
يحتفظ المستودع بمجلد [`assets/examples/`](assets/examples/) للأعمال القادمة. لن يُضاف إلا عمل مكتمل بأسلوب 009 ومؤكد من صاحب المشروع؛ ولن تُستخدم منشورات أو صور من أساليب أخرى كعناصر مؤقتة.

ستعرض النماذج القادمة قدرة 009 على التكيف فقط، ولن تصبح موضوعاتها أو استعاراتها أو ألوانها أو نصوصها أو نسبها مراجع للتوليد أو قيماً افتراضية.

## أربعة مخرجات ومنطق مكاني واحد بالنقاط النصفية
...
| --- | --- | --- |
| `top-bottom` | متكيف مع المصدر | الصورة كاملة في الأعلى، وطبعة 009 المكانية الدنيا بالنقاط في الأسفل؛ يحتفظ اللوحان بمقاس المصدر وينقسمان 50/50 بدقة |
| `left-right` | متكيف مع المصدر | الصورة كاملة في اليسار، وطبعة 009 المكانية الدنيا بالنقاط في اليمين؛ يحتفظ اللوحان بمقاس المصدر وينقسمان 50/50 بدقة |
...
الأولوية هي: البكسلات الدقيقة التي يحددها المستخدم، ثم النسبة أو الوجهة، ثم التكيف مع المصدر في الأنماط العادية. نسبة 3:4 في ملف `009.md` كانت لوحة إبداعية أولى وليست قيمة افتراضية صامتة في المهارة الحالية.
...
- **أربعة أعمال مستقلة:** يرجع كل جهاز إلى الصورة الأصلية وحدها، ويستكشف موضعاً مختلفاً للمرساة الصغيرة واتجاهاً وعلاقة مكانية ومجموعة ألوان موضعية ومسار نقاط وتدخلاً نصياً.
...
ينشئ نموذج الصور مرساة صغيرة مرتبطة بالمصدر واتجاهاً وعلاقة مكانية واحدين وفراغاً ورقياً واسعاً وألواناً موضعية محدودة وانتقالات بكثافة النقاط وأثر طباعة حريرية مادياً ونصاً مندمجاً في الفضاء. ولا يتولى `scripts/compose_panel.py` سوى تخطيط اللوحة والتركيب النقطي الدقيق بنسبة 50/50 وتثبيت المقاس والمراجعة؛ ولا يرسم العمل برمجياً.
