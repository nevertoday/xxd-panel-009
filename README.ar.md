...
لهذا الإحباط صنعت **Panel 009**. هو لا يضع قالباً فوق الصورة؛ بل يحدد أولاً ما لا يجوز فقدانه، ثم يترجمه إلى **يحوّل الصورة إلى قصيدة مكانية بمرساة صغيرة وفراغ واسع ونقاط تتدرج من الكثافة إلى التلاشي**.
